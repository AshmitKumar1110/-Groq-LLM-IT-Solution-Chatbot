...
A high-speed IT support chatbot powered by **Groq’s ultra-low-latency LLMs**. This project uses **Llama 3.1 (8B Instant)** via the Groq API with a **Gradio-based chat interface** to deliver instant troubleshooting and smart IT assistance.
...
- Automate basic IT tasks (ticketing assistance, password reset guidance)  
